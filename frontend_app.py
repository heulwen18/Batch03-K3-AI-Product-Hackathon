...
def _trend_svg(turns: pd.DataFrame) -> str:
    ...
    label_indexes = sorted(set([0, len(raw_labels) // 2, len(raw_labels) - 1]))
        ...
        <section class="app-shell" aria-label="AI Learning Analytics Copilot">
          <aside class="mock-sidebar">
            ...
            <nav class="mock-nav" aria-label="Main navigation">
              <a class="active"><span>✦</span>Live Dashboard</a>
              <a><span>◉</span>Conversations</a>
              <a><span>♢</span>Alerts</a>
              <a><span>⌁</span>Topics</a>
          ...
          <main class="dashboard-main">
              ...
              <div class="header-actions">
                ...
                <span class="notification" aria-label="Notifications">
                  <svg viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M18 9.2a6 6 0 0 0-12 0c0 7-2.2 7.8-2.2 7.8h16.4S18 16.2 18 9.2Z"></path>
            ...
            <div class="status-bar">
              ...
              <span>Độ tin cậy TB {confidence}% · Cập nhật lần cuối {latest_time} ↗</span>
            </div>
          </main>
        </section>
        """
...
def inject_styles() -> None:
    st.markdown(
        ...
        * { box-sizing: border-box; }
        html, body, [class*="css"] { font-family: Inter, ui-sans-serif, -apple-system,
        ...
        .processing-card strong i, .status-bar i {
        ...
        .page-title p { margin: 7px 0 0; font-size: 7.5px; color: #959BAD; }
        .header-actions {
          display: flex;
          align-items: center;
          gap: 11px;
        ...
        .metric-head {
          ...
          font-size: 8px; color: #4C5265; font-weight: 750; white-space: nowrap;
        }
        .metric-icon {
        ...
        .metric-sub { margin-top: 6px; color: #8C92A5; font-size: 7px; }
        ...
        .panel-heading h3 { margin: 0; font-size: 9px; font-weight: 800; color: #2E3344; }
        .ghost-button {
          appearance: none; border: 0; background: transparent; color: #9298A9;
          font: inherit; font-size: 6.8px; white-space: nowrap; padding: 1px 0;
        }
        .legend { display: flex; gap: 14px; margin-top: 9px; }
        .legend span { display: inline-flex; align-items: center; font-size: 6.8px; color: #858B9E; }
        .legend i { width: 5px; height: 5px; border-radius: 50%; margin-right: 5px; }
        .trend-svg { display: block; width: 100%; height: 145px; }
        .issue-list { padding: 2px 0 1px; }
        .issue-row {
          display: grid; grid-template-columns: 13px minmax(56px, 1fr) minmax(42px, .62fr) 35px;
          align-items: center; gap: 6px; padding: 6px 0; font-size: 7px;
        }
        ...
        .issue-count { color: #969BAD; text-align: right; font-size: 6.5px; }
        ...
        .alert-row strong { display: block; font-size: 7px; color: #42485B; }
        .alert-row p { margin: 2px 0; font-size: 6.4px; color: #858B9D; line-height: 1.32; }
        .alert-row a { font-size: 6px; color: #6F54E8; }
        .alert-row time { font-size: 6px; color: #A1A6B6; text-align: right; }
        .action-card {
        ...
        .time-badge {
          display: inline-flex; align-items: center; color: #7760E9; font-size: 6.8px;
        }
        .time-badge:before {
        ...
        .conversation-copy p {
          margin: 0 0 3px; color: #525769; font-size: 6.8px; overflow: hidden;
          text-overflow: ellipsis; white-space: nowrap;
        }
        .conversation-copy span {
          display: inline-block; padding: 2px 5px; border-radius: 4px; font-size: 5.8px;
        }
        .topic-pill {
          justify-self: end; max-width: 88px; padding: 3px 5px; border-radius: 4px;
          color: #777D8F; background: #F4F5F8; font-size: 5.8px; white-space: nowrap;
        ...
        .topic-block span {
          max-width: 82%; margin-top: 4px; font-size: 6px;
          white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
        }
        .topic-block small { position: absolute; top: 7px; right: 7px; font-size: 5.5px; opacity: .7; }
        ...
        .status-bar {
          ...
          border-radius: 7px; background: white; color: #8D93A5; font-size: 6.8px;
        }
        .empty-note { padding: 14px 0; color: #9AA0B2; font-size: 7px; text-align: center; }
        ...
        @media (min-width: 1350px) {
          ...
          .app-shell { grid-template-columns: 154px minmax(0, 1fr); }
        ...
        @media (max-width: 960px) {
          .app-shell { grid-template-columns: 122px minmax(0, 1fr); }
